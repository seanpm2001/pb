/* equates.h for Chez Scheme Version 9.5.7.5 */
...
#define machine_type_a6fb 0x19
#define machine_type_a6le 0xF
#define machine_type_a6nb 0x1D
#define machine_type_a6nt 0x1F
#define machine_type_a6ob 0x13
#define machine_type_a6osx 0x11
#define machine_type_a6s2 0x15
#define machine_type_alist ((0 . any) (1 . pb) (2 . tpb) (3 . pb32) (4 . tpb32) (5 . i3le) (6 . ti3le) (7 . i3nt) (8 . ti3nt) (9 . i3fb) (10 . ti3fb) (11 . i3ob) (12 . ti3ob) (13 . i3osx) (14 . ti3osx) (15 . a6le) (16 . ta6le) (17 . a6osx) (18 . ta6osx) (19 . a6ob) (20 . ta6ob) (21 . a6s2) (22 . ta6s2) (23 . i3s2) (24 . ti3s2) (25 . a6fb) (26 . ta6fb) (27 . i3nb) (28 . ti3nb) (29 . a6nb) (30 . ta6nb) (31 . a6nt) (32 . ta6nt) (33 . i3qnx) (34 . ti3qnx) (35 . arm32le) (36 . tarm32le) (37 . ppc32le) (38 . tppc32le) (39 . arm64le) (40 . tarm64le) (41 . arm64osx) (42 . tarm64osx) (43 . ppc32osx) (44 . tppc32osx) (45 . arm32fb) (46 . tarm32fb) (47 . ppc32fb) (48 . tppc32fb) (49 . arm64fb) (50 . tarm64fb) (51 . arm32ob) (52 . tarm32ob) (53 . ppc32ob) (54 . tppc32ob) (55 . arm64ob) (56 . tarm64ob) (57 . arm32nb) (58 . tarm32nb) (59 . ppc32nb) (60 . tppc32nb) (61 . arm64nb) (62 . tarm64nb))
#define machine_type_any 0x0
#define machine_type_arm32fb 0x2D
#define machine_type_arm32le 0x23
#define machine_type_arm32nb 0x39
#define machine_type_arm32ob 0x33
#define machine_type_arm64fb 0x31
#define machine_type_arm64le 0x27
#define machine_type_arm64nb 0x3D
#define machine_type_arm64ob 0x37
#define machine_type_arm64osx 0x29
#define machine_type_i3fb 0x9
#define machine_type_i3le 0x5
#define machine_type_i3nb 0x1B
#define machine_type_i3nt 0x7
#define machine_type_i3ob 0xB
#define machine_type_i3osx 0xD
#define machine_type_i3qnx 0x21
#define machine_type_i3s2 0x17
#define machine_type_limit 0x3F
#define machine_type_name pb
#define machine_type_pb 0x1
#define machine_type_pb32 0x3
#define machine_type_ppc32fb 0x2F
#define machine_type_ppc32le 0x25
#define machine_type_ppc32nb 0x3B
#define machine_type_ppc32ob 0x35
#define machine_type_ppc32osx 0x2B
#define machine_type_ta6fb 0x1A
#define machine_type_ta6le 0x10
#define machine_type_ta6nb 0x1E
#define machine_type_ta6nt 0x20
#define machine_type_ta6ob 0x14
#define machine_type_ta6osx 0x12
#define machine_type_ta6s2 0x16
#define machine_type_tarm32fb 0x2E
#define machine_type_tarm32le 0x24
#define machine_type_tarm32nb 0x3A
#define machine_type_tarm32ob 0x34
#define machine_type_tarm64fb 0x32
#define machine_type_tarm64le 0x28
#define machine_type_tarm64nb 0x3E
#define machine_type_tarm64ob 0x38
#define machine_type_tarm64osx 0x2A
#define machine_type_ti3fb 0xA
#define machine_type_ti3le 0x6
#define machine_type_ti3nb 0x1C
#define machine_type_ti3nt 0x8
#define machine_type_ti3ob 0xC
#define machine_type_ti3osx 0xE
#define machine_type_ti3qnx 0x22
#define machine_type_ti3s2 0x18
#define machine_type_tpb 0x2
#define machine_type_tpb32 0x4
#define machine_type_tppc32fb 0x30
#define machine_type_tppc32le 0x26
...
#define pb_call 0xD2
#define pb_call_arena_in 0xDA
#define pb_call_arena_out 0xDB
...
#define pb_call_int32_uptr_uptr_uptr 0x1F
...
#define pb_call_uptr 0x20
#define pb_call_uptr_double_double_double_double_double_double 0x3F
#define pb_call_uptr_int32 0x22
#define pb_call_uptr_int32_int32_int32_uptr 0x36
#define pb_call_uptr_int32_int32_uptr 0x2F
#define pb_call_uptr_int32_int32_uptr_uptr 0x33
#define pb_call_uptr_int32_uptr 0x26
#define pb_call_uptr_int32_uptr_uptr_uptr 0x32
#define pb_call_uptr_int32_voids_uptr_uptr 0x34
#define pb_call_uptr_uptr 0x21
#define pb_call_uptr_uptr_int32 0x25
#define pb_call_uptr_uptr_int32_int32 0x2C
#define pb_call_uptr_uptr_int32_uptr_uptr_uptr_uptr 0x3B
#define pb_call_uptr_uptr_int64 0x27
#define pb_call_uptr_uptr_uptr 0x24
#define pb_call_uptr_uptr_uptr_int32 0x2D
#define pb_call_uptr_uptr_uptr_uptr 0x2E
#define pb_call_uptr_uptr_uptr_uptr_uptr 0x35
...
#define pb_call_uptr_uptr_voids 0x28
#define pb_call_uptr_uptr_voids_uptr_uptr 0x37
#define pb_call_uptr_voids 0x23
#define pb_call_uptr_voids_int32 0x2A
#define pb_call_uptr_voids_int32_int32 0x30
#define pb_call_uptr_voids_uptr 0x29
#define pb_call_uptr_voids_uptr_uptr 0x31
#define pb_call_uptr_voids_voids 0x2B
...
#define pb_eq 0x0
#define pb_fals 0x0
#define pb_fence 0xDF
#define pb_fence_acquire 0x1
#define pb_fence_pb_fence_acquire 0xE0
#define pb_fence_pb_fence_release 0xE1
#define pb_fence_pb_fence_store_store 0xDF
...
#define pb_fp_call_arena_in 0xDC
#define pb_fp_call_arena_out 0xDD
...
#define pb_not 0x0
#define pb_prototype_table (((void* uptr) . 65) ((void*) . 64) ((uptr double double double double double double) . 63) ((uptr uptr uptr uptr uptr uptr uptr uptr) . 62) ((uptr uptr uptr uptr uptr uptr uptr int32) . 61) ((uptr uptr uptr uptr uptr uptr uptr) . 60) ((uptr uptr int32 uptr uptr uptr uptr) . 59) ((uptr void* void* void* void* uptr) . 58) ((uptr uptr uptr uptr uptr uptr) . 57) ((uptr uptr uptr uptr uptr int32) . 56) ((uptr uptr void* uptr uptr) . 55) ((uptr int32 int32 int32 uptr) . 54) ((uptr uptr uptr uptr uptr) . 53) ((uptr int32 void* uptr uptr) . 52) ((uptr int32 int32 uptr uptr) . 51) ((uptr int32 uptr uptr uptr) . 50) ((uptr void* uptr uptr) . 49) ((uptr void* int32 int32) . 48) ((uptr int32 int32 uptr) . 47) ((uptr uptr uptr uptr) . 46) ((uptr uptr uptr int32) . 45) ((uptr uptr int32 int32) . 44) ((uptr void* void*) . 43) ((uptr void* int32) . 42) ((uptr void* uptr) . 41) ((uptr uptr void*) . 40) ((uptr uptr int64) . 39) ((uptr int32 uptr) . 38) ((uptr uptr int32) . 37) ((uptr uptr uptr) . 36) ((uptr void*) . 35) ((uptr int32) . 34) ((uptr uptr) . 33) ((uptr) . 32) ((int32 uptr uptr uptr) . 31) ((int32 uptr uptr uptr uptr uptr) . 30) ((double double double) . 29) ((double uptr) . 28) ((double double) . 27) ((uint32) . 26) ((int32 void* void* void* void* uptr) . 25) ((int32 double double double double double double) . 24) ((int32 void* int32) . 23) ((int32 int32 void*) . 22) ((int32 int32 int32) . 21) ((int32 uptr uptr) . 20) ((int32 uptr int32) . 19) ((int32 int32 uptr) . 18) ((int32 void*) . 17) ((int32 uptr) . 16) ((int32 int32) . 15) ((int32) . 14) ((void uptr uptr uptr uptr uptr) . 13) ((void uptr uptr uptr) . 12) ((void void* void*) . 11) ((void uptr void*) . 10) ((void int32 void*) . 9) ((void uptr uptr) . 8) ((void int32 int32) . 7) ((void int32 uptr) . 6) ((void uptr uint32) . 5) ((void void*) . 4) ((void uint32) . 3) ((void int32) . 2) ((void uptr) . 1) ((void) . 0))
...
#define scheme_version 0x9050705
